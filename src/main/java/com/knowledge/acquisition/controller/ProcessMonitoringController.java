 ...
 *
 * <p>This controller provides comprehensive monitoring data for all running processes, including:
 *
 * <ul>
 *   <li>Real-time progress tracking for active processes
 *   <li>Token consumption and efficiency metrics
 *   <li>Cost analysis using Gemini 2.5 Flash pricing
 *   <li>System-wide statistics and aggregations
 *   <li>Recently completed process history
 * </ul>
 *
 * <p>Designed for building live dashboards and monitoring tools.
 */
@RestController
